...
internal class UnixServerTransportSink : IServerChannelSink, IChannelSinkBase
{
	...
	internal void InternalProcessMessage(ClientConnection connection, Stream stream)
	{
		...
		ServerProcessing val2 = next_sink.ProcessMessage((IServerChannelSinkStack)(object)val, (IMessage)null, headers, stream2, ref val3, ref requestHeaders, ref data);
		ServerProcessing val4 = val2;
		switch ((int)val4)
		{
		case 0:

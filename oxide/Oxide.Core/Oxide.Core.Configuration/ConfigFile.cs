...
public abstract class ConfigFile
{
	...
	{
		JsonConvert.PopulateObject(File.ReadAllText(filename ?? Filename), this, SerializerSettings);
	}

	public virtual void Save(string filename = null)
	{
		string contents = JsonConvert.SerializeObject(this, SerializerSettings);

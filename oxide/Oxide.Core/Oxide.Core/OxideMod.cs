...
public sealed class OxideMod
{
	...
	public void Load()
	{
		...
		extensionManager.RegisterLibrary("Plugins", new Oxide.Core.Libraries.Plugins(RootPluginManager));
		...
		RemoteConsole = new Oxide.Core.RemoteConsole.RemoteConsole();
	...
	public bool EnableConsole(bool force = false)
	{
		...
		{
			ServerConsole = new Oxide.Core.ServerConsole.ServerConsole();

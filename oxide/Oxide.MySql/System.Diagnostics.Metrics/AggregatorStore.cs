...
internal struct AggregatorStore<TAggregator>(Func<TAggregator> createAggregator) where TAggregator : Aggregator
{
	...
	public ConcurrentDictionary<TObjectSequence, TAggregator> GetLabelValuesDictionary<TStringSequence, TObjectSequence>([In][_003Cb470df79_002Da5b8_002D442e_002D9a19_002Ddc7ef3b9a2cb_003EIsReadOnly] ref TStringSequence names) where TStringSequence : IStringSequence, IEquatable<TStringSequence> where TObjectSequence : IObjectSequence, IEquatable<TObjectSequence>
	{
		MultiSizeLabelNameDictionary<TAggregator> multiSizeLabelNameDictionary2;
		while (true)
		{

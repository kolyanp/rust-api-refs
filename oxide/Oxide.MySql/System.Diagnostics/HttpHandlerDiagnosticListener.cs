...
internal sealed class HttpHandlerDiagnosticListener : DiagnosticListener
{
	...
	private static void PrepareReflectionObjects()
	{
		...
		{
			throw new InvalidOperationException(_003C98aa27ce_002Da3b7_002D4f67_002D9b18_002D59078b0717c9_003ESR.UnableToInitialize);
		}
	}
	...
	private static void PerformInjection()
	{
		...
		if (field == null)
		{
			throw new InvalidOperationException(_003C98aa27ce_002Da3b7_002D4f67_002D9b18_002D59078b0717c9_003ESR.UnableAccessServicePointTable);
		}

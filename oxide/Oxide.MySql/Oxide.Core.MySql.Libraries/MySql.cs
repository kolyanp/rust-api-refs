...
public class MySql : Library, IDatabaseProvider
{
	...
	{
		return OpenDb(string.Format("Server={0};Port={1};Database={2};User={3};Password={4};Pooling=false;default command timeout=120;Allow Zero Datetime=true;SslMode=Disabled;AllowPublicKeyRetrieval=true;CharSet=utf8mb4;", new object[5] { host, port, database, user, password }), plugin, persistent);
	}

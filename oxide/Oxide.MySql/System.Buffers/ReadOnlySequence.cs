...
{
	public struct Enumerator([In][_003Cfdd897db_002D548f_002D4ce5_002D8c3c_002D053982a32f17_003EIsReadOnly] ref ReadOnlySequence<T> sequence)
	{
	...
	public ReadOnlySequence(ReadOnlySequenceSegment<T> startSegment, int startIndex, ReadOnlySequenceSegment<T> endSegment, int endIndex)
	{
		...
		{
			_003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.ThrowArgumentValidationException(startSegment, startIndex, endSegment);
		}
	...
	public ReadOnlySequence(T[] array)
	{
		if (array == null)
		{
			_003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.ThrowArgumentNullException(_003Ccc7a1cbb_002D4170_002D432f_002Db89a_002De8b4f50166fc_003EExceptionArgument.array);
		}
	...
	public ReadOnlySequence(T[] array, int start, int length)
	{
		...
		{
			_003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.ThrowArgumentValidationException(array, start);
		}
	...
	public ReadOnlySequence(ReadOnlyMemory<T> memory)
	{
		...
		else if (typeof(T) == typeof(char))
		{
			...
			{
				_003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.ThrowInvalidOperationException();
			}
	...
	public ReadOnlySequence<T> Slice(long start, long length)
	{
		if (start < 0 || length < 0)
		{
			_003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.ThrowStartOrEndArgumentValidationException(start);
		}
		...
		if (obj != obj2)
		{
			...
			else
			{
				if (num < 0)
				{
					_003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.ThrowArgumentOutOfRangeException_PositionOutOfRange();
				}
				position = SeekMultiSegment(readOnlySequenceSegment.Next, obj2, index2, start - num, _003Ccc7a1cbb_002D4170_002D432f_002Db89a_002De8b4f50166fc_003EExceptionArgument.start);
				...
				else
				{
					...
					{
						_003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.ThrowStartOrEndArgumentValidationException(0L);
					}
		...
		else
		{
			...
			{
				_003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.ThrowStartOrEndArgumentValidationException(-1L);
			}
			index += (int)start;
			position = new SequencePosition(obj, index);
	...
	public ReadOnlySequence<T> Slice(long start, SequencePosition end)
	{
		...
		else
		{
			...
			if (num3 <= start)
			{
				...
				SequencePosition start2 = SeekMultiSegment(readOnlySequenceSegment.Next, obj, (int)index, start - num3, _003Ccc7a1cbb_002D4170_002D432f_002Db89a_002De8b4f50166fc_003EExceptionArgument.start);
	...
	public ReadOnlySequence<T> Slice(SequencePosition start, long length)
	{
		...
		else
		{
			...
			{
				_003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.ThrowArgumentOutOfRangeException(_003Ccc7a1cbb_002D4170_002D432f_002Db89a_002De8b4f50166fc_003EExceptionArgument.length);
			}
			...
			if (num3 < length)
			{
				...
				SequencePosition end = SeekMultiSegment(readOnlySequenceSegment.Next, obj3, (int)index3, length - num3, _003Ccc7a1cbb_002D4170_002D432f_002Db89a_002De8b4f50166fc_003EExceptionArgument.length);
	...
	public ReadOnlySequence<T> Slice(long start)
	{
		...
		SequencePosition start2 = Seek(ref _sequenceStart, ref _sequenceEnd, start, _003Ccc7a1cbb_002D4170_002D432f_002Db89a_002De8b4f50166fc_003EExceptionArgument.start);
	...
	public SequencePosition GetPosition(long offset, SequencePosition origin)
	{
		if (offset < 0)
		{
			_003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.ThrowArgumentOutOfRangeException_OffsetOutOfRange();
		}
		return Seek(ref origin, ref _sequenceEnd, offset, _003Ccc7a1cbb_002D4170_002D432f_002Db89a_002De8b4f50166fc_003EExceptionArgument.offset);
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	internal bool TryGetBuffer([In][_003Cfdd897db_002D548f_002D4ce5_002D8c3c_002D053982a32f17_003EIsReadOnly] ref SequencePosition position, out ReadOnlyMemory<T> memory, out SequencePosition next)
	{
		...
		if (sequenceType == SequenceType.MultiSegment)
		{
			...
			if (readOnlySequenceSegment != obj2)
			{
				...
				if (next2 == null)
				{
					_003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.ThrowInvalidOperationException_EndPositionNotReached();
				}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private SequencePosition Seek([In][_003Cfdd897db_002D548f_002D4ce5_002D8c3c_002D053982a32f17_003EIsReadOnly] ref SequencePosition start, [In][_003Cfdd897db_002D548f_002D4ce5_002D8c3c_002D053982a32f17_003EIsReadOnly] ref SequencePosition end, long offset, _003Ccc7a1cbb_002D4170_002D432f_002Db89a_002De8b4f50166fc_003EExceptionArgument argument)
	{
		...
		{
			_003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.ThrowArgumentOutOfRangeException(argument);
		}
		return new SequencePosition(obj, index + (int)offset);
	}

	[MethodImpl(MethodImplOptions.NoInlining)]
	private static SequencePosition SeekMultiSegment(ReadOnlySequenceSegment<T> currentSegment, object endObject, int endIndex, long offset, _003Ccc7a1cbb_002D4170_002D432f_002Db89a_002De8b4f50166fc_003EExceptionArgument argument)
	{
		while (true)
		{
	...
	private void BoundsCheck([In][_003Cfdd897db_002D548f_002D4ce5_002D8c3c_002D053982a32f17_003EIsReadOnly] ref SequencePosition position)
	{
	...
	private static SequencePosition GetEndPosition(ReadOnlySequenceSegment<T> startSegment, object startObject, int startIndex, object endObject, int endIndex, long length)
	{
		...
		return SeekMultiSegment(startSegment.Next, endObject, endIndex, length - num, _003Ccc7a1cbb_002D4170_002D432f_002Db89a_002De8b4f50166fc_003EExceptionArgument.length);
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private static int GetIndex([In][_003Cfdd897db_002D548f_002D4ce5_002D8c3c_002D053982a32f17_003EIsReadOnly] ref SequencePosition position)
	{
		return position.GetInteger() & 0x7FFFFFFF;
	}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	private ReadOnlySequence<T> SliceImpl([In][_003Cfdd897db_002D548f_002D4ce5_002D8c3c_002D053982a32f17_003EIsReadOnly] ref SequencePosition start, [In][_003Cfdd897db_002D548f_002D4ce5_002D8c3c_002D053982a32f17_003EIsReadOnly] ref SequencePosition end)
	{

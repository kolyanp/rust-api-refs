...
internal static class Utf8Formatter
{
	...
	public static bool TryFormat(bool value, Span<byte> destination, out int bytesWritten, StandardFormat format = default(StandardFormat))
	{
		...
		return true;
		IL_0083:
		return _003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.TryFormatThrowFormatException(out bytesWritten);
		IL_0033:
		bytesWritten = 4;
		return true;
	}
	...
	public static bool TryFormat(DateTimeOffset value, Span<byte> destination, out int bytesWritten, StandardFormat format = default(StandardFormat))
	{
		...
		return c switch
		{
			...
			_ => _003Cefefee0c_002Dbc34_002D4852_002Da4f2_002Df3a29a97a3fc_003EThrowHelper.TryFormatThrowFormatException(out bytesWritten), 
		};
	}
	...
	public static bool TryFormat(decimal value, Span<byte> destination, out int bytesWritten, StandardFormat format = default(StandardFormat))
	{
		...
		case 'g':
		{
			...
			{
				throw new NotSupportedException(_003Cc1e4ce84_002Db725_002D4d32_002D90ca_002Da752f1fa7530_003ESR.Argument_GWithPrecisionNotSupported);
			}

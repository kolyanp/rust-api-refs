...
public abstract class Server : BaseNetwork
{
	...
	public int encryption = 2;

	public Manager visibility;

	public IServerCallback callbackHandler;

	public static readonly DefaultSubscriberStrategy DefaultSubscriberStrategy = new DefaultSubscriberStrategy();
	...
	public Networkable CreateNetworkable()
	{
		...
		networkable.sv = this;
		networkable.SubStrategy = DefaultSubscriberStrategy;
		return networkable;
	}

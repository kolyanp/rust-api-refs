...
public class Connection
{
	...
	{
		public const uint OutOfOrder = uint.MaxValue;
	...
	public string ipaddress
	{
		...
		set
		{
			...
			if (num != -1)
			{
				ipaddresswithoutport = value.Substring(0, num);
				int num2 = num + 1;
				port = value.Substring(num2, value.Length - num2);
			}
		}
	}
	...
	{
		if (authLevel >= 3 && os == "editor")
		{
			return authStatusSteam == "ok";
		}
		return false;
	}

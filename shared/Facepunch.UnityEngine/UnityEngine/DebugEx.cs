...
public static class DebugEx
{
	...
	public static void Log(object message, StackTraceLogType stacktrace = (StackTraceLogType)0)
	{
	...
	public static void Log(object message, Object context, StackTraceLogType stacktrace = (StackTraceLogType)0)
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		//IL_0008: Unknown result type (might be due to invalid IL or missing references)
	...
	public static void LogWarning(object message, StackTraceLogType stacktrace = (StackTraceLogType)0)
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		//IL_0008: Unknown result type (might be due to invalid IL or missing references)
	...
	public static void LogWarning(object message, Object context, StackTraceLogType stacktrace = (StackTraceLogType)0)
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		//IL_0008: Unknown result type (might be due to invalid IL or missing references)

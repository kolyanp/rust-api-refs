...
public abstract class FacepunchBehaviour : MonoBehaviour
{
	...
	{
		InvokeHandlerUnscaledTime.Invoke((Behaviour)(object)this, action, time);
	}
	...
	{
		InvokeHandlerUnscaledTime.InvokeRepeating((Behaviour)(object)this, action, time, repeat);
	}

	public void InvokeRandomizedUnscaledTime(Action action, float time, float repeat, float random)
	{
		InvokeHandlerUnscaledTime.InvokeRandomized((Behaviour)(object)this, action, time, repeat, random);
	}

	public void CancelInvokeUnscaledTime(Action action)
	{
		InvokeHandlerUnscaledTime.CancelInvoke((Behaviour)(object)this, action);
	}

	public bool IsInvokingUnscaledTime(Action action)
	{
		return InvokeHandlerUnscaledTime.IsInvoking((Behaviour)(object)this, action);
	}
}

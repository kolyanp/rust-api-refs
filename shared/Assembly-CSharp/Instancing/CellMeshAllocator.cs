...
public class CellMeshAllocator
{
	...
	public InstancedMeshData? TryGetMeshData(long virtualMeshId)
	{
		...
		return new InstancedMeshData
		{
			CullData = CullData[value],
			LocalToWorld = PositionData[value]
		};
	}
	...
	public void ExpandData()
	{
		...
		PositionData.Expand<float4x4>(newCapacity, (NativeArrayOptions)1, true, false);

...
{
	public struct PlacementMeshInfo(int placementIdx, int matIdx, int masterIdx, int subMeshIdx, int subFoliageIdx)
	{
		public int placementIdx = placementIdx;

		public int matIdx = matIdx;

		public int masterIdx = masterIdx;

		public int subMeshIdx = subMeshIdx;

		public int subFoliageIdx = subFoliageIdx;
	}

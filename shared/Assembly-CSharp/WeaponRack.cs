...
public class WeaponRack : StorageContainer
{
	...
	private void LoadWeaponAmmo(RPCMessage msg)
	{
		...
		if ((Object)(object)itemDefinition == (Object)null || Interface.CallHook("OnRackedWeaponLoad", slot, itemDefinition, player, this) != null)
		{
			return;
		}
	...
	public bool CanAcceptWeaponType(WorldModelRackMountConfig weaponConfig)
	{
		...
		if (CustomRackType != SpecialRackType.None && weaponConfig.FindCustomRackPosition(CustomRackType) == null)
		{
			return false;
		}
		return true;

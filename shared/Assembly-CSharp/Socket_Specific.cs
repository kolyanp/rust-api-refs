...
public class Socket_Specific : Socket_Base
{
	...
	public override bool TestTarget(Construction.Target target)
	{
		...
		if (blockPlacementOnChildEntities && (Object)(object)target.entity != (Object)null && SocketMod_BoatBuildingBlock.Contained(((Component)target.entity).transform.position, 2f, 134217728, (QueryTriggerInteraction)1, requireHull: false, requireNoParentBoat: true, out var _))
		{
			return false;
		}

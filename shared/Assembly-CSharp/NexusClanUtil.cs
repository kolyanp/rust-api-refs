...
public static class NexusClanUtil
{
	...
	public static ClanRole ToClanRole(this NexusClanRole role)
	{
		...
		return new ClanRole
		{
			...
			CanSetLogo = (flag || (role.TryGetVariable("can_set_logo", ref variable) && ParseFlag(variable))),
			CanSetMotd = (flag || (role.TryGetVariable("can_set_motd", ref variable2) && ParseFlag(variable2))),
			CanSetPlayerNotes = (flag || (role.TryGetVariable("can_set_player_notes", ref variable3) && ParseFlag(variable3))),
	...
	public static ClanMember ToClanMember(this NexusClanMember member)
	{
		...
		return new ClanMember
		{
			...
			Notes = ((val != null) ? val.GetAsString() : null),
			NotesTimestamp = ((val != null) ? val.LastUpdated : 0)
		};
	}

...
{
	private struct NativeStack(Allocator allocator) : IDisposable
	{
		public NativeList<int3> arr = new NativeList<int3>(AllocatorHandle.op_Implicit(allocator));
	...
	public void Execute()
	{
		...
		((NativeBitArray)(ref other))._002Ector(Sampler.Length, AllocatorHandle.op_Implicit((Allocator)2), (NativeArrayOptions)1);
		...
		{
			int num2 = v.x - 1;
			((int3)(ref val2))._002Ector(num2, ((int3)(ref v)).yz);
			int num3 = 0;
			...
			int num4 = v.x + 1;
			((int3)(ref val2))._002Ector(num4, ((int3)(ref v)).yz);
			while (Sampler.InBounds(val2) && Sampler[num3 = Sampler.ToIndex(val2)] && !((NativeBitArray)(ref other)).IsSet(num3))
			{
				((NativeBitArray)(ref other)).Set(num3, true);
				((int3)(ref val2))._002Ector(++num4, ((int3)(ref v)).yz);
			...
			int num5 = v.z - 1;
			((int3)(ref val2))._002Ector(((int3)(ref v)).xy, num5);
			while (Sampler.InBounds(val2) && Sampler[num3 = Sampler.ToIndex(val2)] && !((NativeBitArray)(ref other)).IsSet(num3))
			{
				((NativeBitArray)(ref other)).Set(num3, true);
				((int3)(ref val2))._002Ector(((int3)(ref v)).xy, --num5);
			...
			int num6 = v.z + 1;
			((int3)(ref val2))._002Ector(((int3)(ref v)).xy, num6);
			while (Sampler.InBounds(val2) && Sampler[num3 = Sampler.ToIndex(val2)] && !((NativeBitArray)(ref other)).IsSet(num3))
			{
				((NativeBitArray)(ref other)).Set(num3, true);
				((int3)(ref val2))._002Ector(((int3)(ref v)).xy, ++num6);
			...
			for (int k = num2; k < num4; k++)
			{
				for (int l = num5; l < num6; l++)
				{
					for (int m = -1; m <= 1; m += 2)
					{
						((int3)(ref val2))._002Ector(k, v.y + m, l);

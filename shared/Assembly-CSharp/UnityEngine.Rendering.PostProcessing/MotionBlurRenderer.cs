...
internal sealed class MotionBlurRenderer : PostProcessEffectRenderer<MotionBlur>
{
	...
	public override void Render(PostProcessRenderContext context)
	{
		...
		propertySheet.properties.SetFloat(UnityEngine.Rendering.PostProcessing.ShaderIDs.VelocityScale, num3);
		propertySheet.properties.SetFloat(UnityEngine.Rendering.PostProcessing.ShaderIDs.MaxBlurRadius, (float)num);
		...
		propertySheet.properties.SetVector(UnityEngine.Rendering.PostProcessing.ShaderIDs.TileMaxOffs, Vector4.op_Implicit(val3));
		propertySheet.properties.SetFloat(UnityEngine.Rendering.PostProcessing.ShaderIDs.TileMaxLoop, (float)(int)((float)num2 / 8f));
		...
		propertySheet.properties.SetFloat(UnityEngine.Rendering.PostProcessing.ShaderIDs.LoopCount, (float)Mathf.Clamp((int)base.settings.sampleCount / 2, 1, 64));

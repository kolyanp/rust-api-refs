...
internal sealed class ScalableAO : UnityEngine.Rendering.PostProcessing.IAmbientOcclusionMethod
{
	...
	private void Render(PostProcessRenderContext context, CommandBuffer cmd, int occlusionSource)
	{
		...
		propertySheet.properties.SetVector(UnityEngine.Rendering.PostProcessing.ShaderIDs.AOParams, new Vector4(value, value2, num2, num3));
	...
	public void RenderAfterOpaque(PostProcessRenderContext context)
	{
		...
		command.SetGlobalTexture(UnityEngine.Rendering.PostProcessing.ShaderIDs.SAOcclusionTexture, RenderTargetIdentifier.op_Implicit((Texture)(object)m_Result));

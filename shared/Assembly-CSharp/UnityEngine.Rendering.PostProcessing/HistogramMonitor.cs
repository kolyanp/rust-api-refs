...
public sealed class HistogramMonitor : Monitor
{
	...
	internal override void Render(PostProcessRenderContext context)
	{
		...
		command.SetComputeTextureParam(gammaHistogram, num, "_Source", RenderTargetIdentifier.op_Implicit(UnityEngine.Rendering.PostProcessing.ShaderIDs.HalfResFinalCopy));
		command.SetComputeBufferParam(gammaHistogram, num, "_HistogramBuffer", m_Data);
		...
		propertySheet.properties.SetVector(UnityEngine.Rendering.PostProcessing.ShaderIDs.Params, new Vector4((float)width, (float)height, 0f, 0f));

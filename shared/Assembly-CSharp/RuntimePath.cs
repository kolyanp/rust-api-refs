...
public class RuntimePath : IAIPath
{
	...
	public ReadOnlySpan<IAIPathSpeedZone> SpeedZones => UnsafeListAccess.ListAsReadOnlySpan<IAIPathSpeedZone>(speedZones);

	public ReadOnlySpan<IAIPathInterestNode> InterestNodes => UnsafeListAccess.ListAsReadOnlySpan<IAIPathInterestNode>(interestNodes);

...
public class WaterOverlay : MonoBehaviour, IClientComponent
{
	...
	public struct EffectParams
	{
		...
		public static EffectParams DefaultTropicalShore = new EffectParams
		{
			scatterCoefficient = 1f,
			scatterStrength = 1f,
			blur = true,
	...
	public EffectParams tropicalShoreParams = EffectParams.DefaultTropicalShore;

	public Material[] UnderwaterFogMaterials;

	public float tropicalShoreEffectRange = 40f;
}

...
public static class ColliderEx
{
	...
	public static bool IsOnLayer(this Collider col, Layer rustLayer)
	{
		...
		{
			return GameObjectEx.IsOnLayer(((Component)col).gameObject, rustLayer);
		}
		return false;
	}
	...
	public static bool IsOnLayer(this Collider col, int layer)
	{
		if ((Object)(object)col != (Object)null)
		{
			return GameObjectEx.IsOnLayer(((Component)col).gameObject, layer);
		}
		return false;
	}
	...
	public static MonumentInfo GetMonument(this Collider collider, bool ignoreEntity = true)
	{
		...
		if (ignoreEntity && (Object)(object)GameObjectEx.ToBaseEntity(collider) != (Object)null)
		{
			return null;
		}
		...
		{
			cachedMonumentComponent = Utils.GetOrAddComponent<CachedMonumentComponent>(((Component)collider).gameObject);

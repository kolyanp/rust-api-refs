...
public class MapView : FacepunchBehaviour, IPointerDownHandler, IEventSystemHandler
{
	...
	[Space]
	public GameObject deepSeaMarkerContainer;

	public GameObjectRef deepSeaMapMarkerPrefab;

	[Space]
	public GameObject deepSeaExitContainer;

	public GameObjectRef deepSeaExitMarkerPrefab;
	...
	public bool CanShowDeepSea = true;
	...
	public RustImageButton DeepSeaButton;
	...
	public PaintableImageGrid DeepSeaFogOfWarGrid;

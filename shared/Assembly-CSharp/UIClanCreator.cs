...
public class UIClanCreator : BaseMonoBehaviour
{
	...
	public static readonly Phrase CreateNameInvalidLength = (Phrase)(object)new TokenisedPhrase("clan.create.name_invalid_length", "Clan names must be between {0} and {1} characters long.");

	public static readonly Phrase CreateNameInvalidCharacters = (Phrase)(object)new TokenisedPhrase("clan.create.name_invalid_characters", "Clan names can only contain letters, numbers, spaces, apostrophes, and hyphens.");

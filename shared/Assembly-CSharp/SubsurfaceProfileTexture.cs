...
{
	private struct SubsurfaceProfileEntry(SubsurfaceProfileData data, SubsurfaceProfile profile)
	{
		public SubsurfaceProfileData data = data;

		public SubsurfaceProfile profile = profile;
	}

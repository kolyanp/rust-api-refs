...
public struct TextureData
{
	...
	public float GetInterpolatedFloat(float x, float y)
	{
		...
		int x2 = Mathf.Min(num3 + 1, width - 2);
		int y2 = Mathf.Min(num4 + 1, height - 2);
		float num5 = GetFloat(num3, num4);
		float num6 = GetFloat(x2, num4);
		float num7 = GetFloat(num3, y2);
		float num8 = GetFloat(x2, y2);
		float num9 = num - (float)num3;
		float num10 = num2 - (float)num4;
		float num11 = Mathf.Lerp(num5, num6, num9);
		float num12 = Mathf.Lerp(num7, num8, num9);

...
public class BuoyancyBurstUtility
{
	...
	internal static class FillPointData_000057DA_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<FillPointData_000057DA_0024PostfixBurstDelegate>((FillPointData_000057DA_0024PostfixBurstDelegate)FillPointData).Value;
			}
			P_0 = Pointer;
		}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(FillPointData_000057DA_0024PostfixBurstDelegate))]
	...
	{
		FillPointData_000057DA_0024BurstDirectCall.Invoke(in pointIndexOffset, ref pointPositionArray, ref pointPositionUVArray, in rootToWorld, ref pointData, in deepSeaBounds, in terrainPosition, in terrainOneOverSize, in isDeepSea, ref allPositions3D, out pointCount);
	}

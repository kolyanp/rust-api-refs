...
public static class EnvironmentVolumeMath
{
	...
	internal delegate void CalculateTransformationBoundsBurst_00006020_0024PostfixBurstDelegate(in float4x4 transformationMatrix, in bool capsule, out Bounds bounds);

	internal static class CalculateTransformationBoundsBurst_00006020_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<CalculateTransformationBoundsBurst_00006020_0024PostfixBurstDelegate>((CalculateTransformationBoundsBurst_00006020_0024PostfixBurstDelegate)CalculateTransformationBoundsBurst).Value;
			}
			P_0 = Pointer;
		}
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal delegate void MultiplyPoint3X4_00006021_0024PostfixBurstDelegate(in float4x4 transformationMatrix, in float3 point, out float3 result);

	internal static class MultiplyPoint3X4_00006021_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<MultiplyPoint3X4_00006021_0024PostfixBurstDelegate>((MultiplyPoint3X4_00006021_0024PostfixBurstDelegate)MultiplyPoint3X4).Value;
			}
			P_0 = Pointer;
		}
	...
	internal static class UpdateVolumeTransformationAndBoundsBurst_00006022_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<UpdateVolumeTransformationAndBoundsBurst_00006022_0024PostfixBurstDelegate>((UpdateVolumeTransformationAndBoundsBurst_00006022_0024PostfixBurstDelegate)UpdateVolumeTransformationAndBoundsBurst).Value;
			}
			P_0 = Pointer;
		}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(CalculateTransformationBoundsBurst_00006020_0024PostfixBurstDelegate))]
	...
	[MonoPInvokeCallback(typeof(UpdateVolumeTransformationAndBoundsBurst_00006022_0024PostfixBurstDelegate))]
	[BurstCompile]
	...
	{
		UpdateVolumeTransformationAndBoundsBurst_00006022_0024BurstDirectCall.Invoke(in size, in center, in localToWorldMatrix, in isCapsule, out volumeTransformation, out volumeTransformationInverse, out volumePosition, out volumeBounds);
	}

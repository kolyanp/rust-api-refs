...
internal static class Util
{
	...
	internal delegate int FindFreeSlot_0000887F_0024PostfixBurstDelegate(int rayInd, in NativeArray<RaycastHit> hits, int maxHitsPerRay, out int endInd);

	internal static class FindFreeSlot_0000887F_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<FindFreeSlot_0000887F_0024PostfixBurstDelegate>((FindFreeSlot_0000887F_0024PostfixBurstDelegate)FindFreeSlot).Value;
			}
			P_0 = Pointer;
		}
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal delegate int FindFreeSlot_00008880_0024PostfixBurstDelegate(int rayInd, in ReadOnly<RaycastHit> hits, int maxHitsPerRay, out int endInd);

	internal static class FindFreeSlot_00008880_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<FindFreeSlot_00008880_0024PostfixBurstDelegate>((FindFreeSlot_00008880_0024PostfixBurstDelegate)GamePhysicsJobs.Util.FindFreeSlot).Value;
			}
			P_0 = Pointer;
		}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(GamePhysicsJobs_002EFindFreeSlot_0000887F_0024PostfixBurstDelegate))]
	public static int FindFreeSlot(int rayInd, in NativeArray<RaycastHit> hits, int maxHitsPerRay, out int endInd)
	{
		return FindFreeSlot_0000887F_0024BurstDirectCall.Invoke(rayInd, in hits, maxHitsPerRay, out endInd);
	}

	[MonoPInvokeCallback(typeof(GamePhysicsJobs_002EFindFreeSlot_00008880_0024PostfixBurstDelegate))]
	[BurstCompile]
	public static int FindFreeSlot(int rayInd, in ReadOnly<RaycastHit> hits, int maxHitsPerRay, out int endInd)
	{
		return FindFreeSlot_00008880_0024BurstDirectCall.Invoke(rayInd, in hits, maxHitsPerRay, out endInd);
	}

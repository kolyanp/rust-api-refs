...
public class DiamondGraph : UIPrimitiveBase
{
	...
	protected override void OnPopulateMesh(VertexHelper vh)
	{
		...
		vh.AddVert(new Vector3((0f - num) * m_a, 0f), val, Vector4.op_Implicit(new Vector2(0f, 0f)));
		vh.AddVert(new Vector3(0f, num * m_b), val, Vector4.op_Implicit(new Vector2(0f, 1f)));
		vh.AddVert(new Vector3(num * m_c, 0f), val, Vector4.op_Implicit(new Vector2(1f, 1f)));
		vh.AddVert(new Vector3(0f, (0f - num) * m_d), val, Vector4.op_Implicit(new Vector2(1f, 0f)));

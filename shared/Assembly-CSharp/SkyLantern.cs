...
public class SkyLantern : StorageContainer, IIgniteable
{
	...
	public void Ignite(Vector3 fromPos)
	{
		...
		//IL_0055: Unknown result type (might be due to invalid IL or missing references)
		TransformEx.RemoveComponent<GroundWatch>(((Component)this).gameObject.transform);
		TransformEx.RemoveComponent<DestroyOnGroundMissing>(((Component)this).gameObject.transform);

...
public static class FileEx
{
	...
	public static NativeArray<byte> ReadAllBytesNative(string fileName, Allocator allocator)
	{
		...
		NativeMemoryStream val = new NativeMemoryStream((int)length, allocator, false);
		File.OpenRead(fileName).CopyTo((Stream)(object)val);
		NativeArray<byte> buffer = val.Buffer;

...
public class Kayak : BaseBoat, IPoolVehicle
{
	...
	public override void DoPushAction(BasePlayer player)
	{
		...
		else
		{
			...
			rigidBody.AddForceAtPosition(val * num * rigidBody.mass, position, (ForceMode)1);
		}
		if (IsInWater())
		{
	...
	public override void VehicleFixedUpdate()
	{
		...
		using (TimeWarning.New("Kayak.VehicleFixedUpdate"))
		{
			...
			if (inCinematic)
			{
				...
				{
					Vector3 linearVelocity = rigidBody.linearVelocity;
					linearVelocity = Vector3.MoveTowards(linearVelocity, Vector3Ex.WithZ(Vector3Ex.WithX(linearVelocity, 0f), 0f), Time.fixedDeltaTime);

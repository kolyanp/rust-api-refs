...
public class WaterVolumeBurst
{
	...
	internal delegate bool TestBurst_0000651B_0024PostfixBurstDelegate(in Vector3 position, out WaterLevel.WaterInfo info, float queryRadius = 100f);

	internal static class TestBurst_0000651B_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<TestBurst_0000651B_0024PostfixBurstDelegate>((TestBurst_0000651B_0024PostfixBurstDelegate)TestBurst).Value;
			}
			P_0 = Pointer;
		}
	...
	[MonoPInvokeCallback(typeof(TestBurst_0000651B_0024PostfixBurstDelegate))]
	[BurstCompile]
	public static bool TestBurst(in Vector3 position, out WaterLevel.WaterInfo info, float queryRadius = 100f)
	{
		return TestBurst_0000651B_0024BurstDirectCall.Invoke(in position, out info, queryRadius);
	}

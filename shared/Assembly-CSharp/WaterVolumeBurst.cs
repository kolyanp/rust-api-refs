...
public class WaterVolumeBurst
{
	...
	internal delegate bool TestBurst_00006522_0024PostfixBurstDelegate(in Vector3 position, out WaterLevel.WaterInfo info, float queryRadius = 100f);

	internal static class TestBurst_00006522_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<TestBurst_00006522_0024PostfixBurstDelegate>((TestBurst_00006522_0024PostfixBurstDelegate)TestBurst).Value;
			}
			P_0 = Pointer;
		}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(TestBurst_00006522_0024PostfixBurstDelegate))]
	public static bool TestBurst(in Vector3 position, out WaterLevel.WaterInfo info, float queryRadius = 100f)
	{
		return TestBurst_00006522_0024BurstDirectCall.Invoke(in position, out info, queryRadius);
	}

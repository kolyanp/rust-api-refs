...
public class IndustrialCrafter : IndustrialEntity, IItemContainerEntity, IIdealSlotEntity, ILootableEntity, IInventoryProvider, LootPanel.IHasLootPanel, IContainerSounds, IIndustrialStorage
{
	...
	protected override void RunJob()
	{
		...
		base.RunJob();
		if (ConVar.Server.industrialCrafterFrequency <= 0f || HasFlag(Flags.Reserved1) || (Object)(object)currentlyCrafting != (Object)null)
		{
			return;
		}
		for (int i = 0; i <= 3; i++)
		{
			...
			if ((Object)(object)workbench != (Object)null && workbench.InstalledUpgradeCount > 0)
			{
				num *= workbench.GetCraftSpeedMultiplier(null);
			}
			Invoke(CompleteCraft, num);
			jobFinishes = TimeUntilWithDuration.op_Implicit(num);
	...
	private void CompleteCraft()
	{
		...
		ItemCraftTask itemCraftTask = null;
		if (num != 0 && (Object)(object)itemBlueprint != (Object)null)
		{
			itemCraftTask = Pool.Get<ItemCraftTask>();
			itemCraftTask.blueprint = itemBlueprint;
			itemCraftTask.amount = 0;
			itemCraftTask.numCrafted = 1;
		}
		...
		{
			workbench.ApplyUpgradesToCraftedItem(null, itemCraftTask, item);
		}
		List<Item> list = null;
		if ((Object)(object)workbench != (Object)null && itemCraftTask != null)
		{
		...
		{
			Pool.FreeUnsafe<ItemCraftTask>(ref itemCraftTask);
		}
		if (!TryInsertToOutput(item))
		{
			item.Drop(((Component)this).transform.position + ((Component)this).transform.forward * 0.5f, Vector3.zero);
		}
		if (list != null)
		{
	...
	private bool TryInsertToOutput(Item newItem)
	{
		...
		{
			Item slot = _inventory.GetSlot(i);
			if (slot != null && (Object)(object)slot.info == (Object)(object)newItem.info && slot.amount + newItem.amount <= slot.MaxStackable())
			{

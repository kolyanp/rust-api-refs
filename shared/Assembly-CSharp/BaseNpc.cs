...
public class BaseNpc : BaseCombatEntity
{
	...
	public RustNavMeshAgent GetNavAgent
	{
		get
		{
			...
			{
				NavAgent = ((Component)this).GetComponent<RustNavMeshAgent>();
				if ((Object)(object)NavAgent == (Object)null)
				{
	...
	public virtual void StartAttack()
	{
		...
		//IL_0042: Unknown result type (might be due to invalid IL or missing references)
		//IL_00c4: Unknown result type (might be due to invalid IL or missing references)
		if (!Object.op_Implicit((Object)(object)AttackTarget) || !AttackReady() || Interface.CallHook("OnNpcAttack", this, AttackTarget) != null)
		{
			return;
		}

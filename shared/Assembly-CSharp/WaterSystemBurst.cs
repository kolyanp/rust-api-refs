...
public class WaterSystemBurst
{
	...
	internal delegate void GetHeightArray_Burst_00007097_0024PostfixBurstDelegate(in ReadOnly<Vector2> posUV, ref NativeArray<float> shore, ref NativeArray<float> terrainHeight, in TerrainTexturing.ShoreData shoreData, in TerrainHeightMap.HeightMapQueryStructure terrainHeightMapData, in bool hasHeightMap, in bool hasTerrainTexturing);

	internal static class GetHeightArray_Burst_00007097_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<GetHeightArray_Burst_00007097_0024PostfixBurstDelegate>((GetHeightArray_Burst_00007097_0024PostfixBurstDelegate)GetHeightArray_Burst).Value;
			}
			P_0 = Pointer;
		}
	...
	internal static class ComputeOceanSimHeight_Burst_00007098_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<ComputeOceanSimHeight_Burst_00007098_0024PostfixBurstDelegate>((ComputeOceanSimHeight_Burst_00007098_0024PostfixBurstDelegate)ComputeOceanSimHeight_Burst).Value;
			}
			P_0 = Pointer;
		}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(GetHeightArray_Burst_00007097_0024PostfixBurstDelegate))]
	...
	{
		GetHeightArray_Burst_00007097_0024BurstDirectCall.Invoke(in posUV, ref shore, ref terrainHeight, in shoreData, in terrainHeightMapData, in hasHeightMap, in hasTerrainTexturing);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(ComputeOceanSimHeight_Burst_00007098_0024PostfixBurstDelegate))]
	...
	{
		ComputeOceanSimHeight_Burst_00007098_0024BurstDirectCall.Invoke(in pos, in posUV, ref shore, ref waterHeight, in isDeepSea, in hasWaterAndTopology, in topologyQueryStructure, in OceanLevel, in MaxOceanLevel, in hasWaterSystem, in waterMapQueryStruct);
	}

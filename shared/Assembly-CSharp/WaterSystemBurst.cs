...
public class WaterSystemBurst
{
	...
	internal static class GetHeightArray_Burst_000071FD_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<GetHeightArray_Burst_000071FD_0024PostfixBurstDelegate>((GetHeightArray_Burst_000071FD_0024PostfixBurstDelegate)GetHeightArray_Burst).Value;
			}
			P_0 = Pointer;
		}
	...
	internal static class ComputeOceanSimHeight_Burst_000071FE_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<ComputeOceanSimHeight_Burst_000071FE_0024PostfixBurstDelegate>((ComputeOceanSimHeight_Burst_000071FE_0024PostfixBurstDelegate)ComputeOceanSimHeight_Burst).Value;
			}
			P_0 = Pointer;
		}

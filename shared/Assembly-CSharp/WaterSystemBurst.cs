...
public class WaterSystemBurst
{
	...
	internal static class GetHeightArray_Burst_000071F6_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<GetHeightArray_Burst_000071F6_0024PostfixBurstDelegate>((GetHeightArray_Burst_000071F6_0024PostfixBurstDelegate)GetHeightArray_Burst).Value;
			}
			P_0 = Pointer;
		}
	...
	internal static class ComputeOceanSimHeight_Burst_000071F7_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<ComputeOceanSimHeight_Burst_000071F7_0024PostfixBurstDelegate>((ComputeOceanSimHeight_Burst_000071F7_0024PostfixBurstDelegate)ComputeOceanSimHeight_Burst).Value;
			}
			P_0 = Pointer;
		}
	...
	[MonoPInvokeCallback(typeof(GetHeightArray_Burst_000071F6_0024PostfixBurstDelegate))]
	[BurstCompile]
	...
	{
		GetHeightArray_Burst_000071F6_0024BurstDirectCall.Invoke(in posUV, ref shore, ref terrainHeight, in shoreData, in terrainHeightMapData, in hasHeightMap, in hasTerrainTexturing);
	}

	[MonoPInvokeCallback(typeof(ComputeOceanSimHeight_Burst_000071F7_0024PostfixBurstDelegate))]
	[BurstCompile]
	...
	{
		ComputeOceanSimHeight_Burst_000071F7_0024BurstDirectCall.Invoke(in pos, in posUV, ref shore, ref waterHeight, in isDeepSea, in hasWaterAndTopology, in topologyQueryStructure, in OceanLevel, in MaxOceanLevel, in hasWaterSystem, in waterMapQueryStruct);
	}

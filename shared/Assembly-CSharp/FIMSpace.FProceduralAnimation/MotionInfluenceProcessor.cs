...
public class MotionInfluenceProcessor
{
	...
	public Vector3 AxisMotionInfluence;

	public Vector3 AxisMotionInfluenceBackwards;
	...
	[CompilerGenerated]
	private Vector3 _003COutputInfluenceOffset_003Ek__BackingField;

	[CompilerGenerated]
	private Vector3 _003CpreviousPosition_003Ek__BackingField;

	[CompilerGenerated]
	private Vector3 _003CrootOffset_003Ek__BackingField;

	[CompilerGenerated]
	private Vector3 _003ClocalOffset_003Ek__BackingField;

	public Vector3 OutputInfluenceOffset
	{
		[CompilerGenerated]
		get
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003COutputInfluenceOffset_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			...
			_003COutputInfluenceOffset_003Ek__BackingField = value;
		}
	}
	...
	public Vector3 previousPosition
	{
		...
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003CpreviousPosition_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0002: Unknown result type (might be due to invalid IL or missing references)
			_003CpreviousPosition_003Ek__BackingField = value;
		}
	}
	...
	public Vector3 rootOffset
	{
		...
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003CrootOffset_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0002: Unknown result type (might be due to invalid IL or missing references)
			_003CrootOffset_003Ek__BackingField = value;
		}
	}
	...
	public Vector3 localOffset
	{
		...
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			return _003ClocalOffset_003Ek__BackingField;
		}
		[CompilerGenerated]
		private set
		{
			//IL_0001: Unknown result type (might be due to invalid IL or missing references)
			//IL_0002: Unknown result type (might be due to invalid IL or missing references)
			_003ClocalOffset_003Ek__BackingField = value;
		}
	}
	...
	public MotionInfluenceProcessor()
	{
		//IL_0001: Unknown result type (might be due to invalid IL or missing references)
		//IL_0006: Unknown result type (might be due to invalid IL or missing references)
		//IL_000c: Unknown result type (might be due to invalid IL or missing references)
		//IL_0011: Unknown result type (might be due to invalid IL or missing references)
		AxisMotionInfluence = Vector3.one;
		AxisMotionInfluenceBackwards = Vector3.one;
		MultiplyBlend = 1f;
		ExtraBoost = 1f;
		base._002Ector();
	}

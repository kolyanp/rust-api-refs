...
public class LegsAnimator : MonoBehaviour, IDropHandler, IEventSystemHandler, IFHierarchyIcon
{
	...
	public class Leg
	{
		...
		public void Glue_Reset(bool initializing)
		{
			...
			{
				PosInAttachementLocal = _FinalIKPos,
				RotInAttachementLocal = _FinalIKRot
			};
		...
		private void StepEventRestore()
		{
			...
			if (Owner.UseGluing)
			{
				...
				if (Owner._glueModeExecuted == EGlueMode.Idle)
				{
					if (!G_DuringAttaching || (Owner.GlueMode == EGlueMode.Automatic && (Owner.IsMoving || Owner.Helper_WasMoving)) || (!Owner.SendOnStopping && Owner.StoppedTime < 0.155f) || G_AttachementHandler.lasGlueModeOnAttaching != EGlueMode.Idle || G_AttachementHandler.legMoveDistanceFactor < 0.05f)
					{
						return;
					}
				}
		...
		{
			if (knownOppositeLeg != null && knownOppositeLeg.Side != ELegSide.Undefined)
			{
		...
		public void AssignOppositeLegIndex(int oppositeIndex)
		{
			...
			{
				if (Object.op_Implicit((Object)(object)Owner) && FLogicMethods.ContainsIndex(Owner.Legs, oppositeIndex, true))
				{
		...
		public Leg GetOppositeLegReference(LegsAnimator legs)
		{
			...
			if (!FLogicMethods.ContainsIndex(legs.Legs, OppositeLegIndex, true))
			{
				return null;
			}
	...
	protected void Hips_PreCalibrate()
	{
		...
		if (Calibrate != ECalibrateMode.None && (Object)(object)SpineBone != (Object)null)
		{
	...
	public Transform Finders_QuickHipsSearch()
	{
		...
		if (Object.op_Implicit((Object)(object)val3))
		{
			...
			if ((Object)(object)val3 == (Object)(object)componentInChildren.rootBone || Enumerable.Contains(componentInChildren.bones, val3) || val3.childCount >= 3)
			{
				return val3;
			}
		}
	...
	{
		if (FLogicMethods.ContainsIndex(Legs, legIndex, true))
		{
	...
	{
		if (FLogicMethods.ContainsIndex(Legs, legID, true))
		{

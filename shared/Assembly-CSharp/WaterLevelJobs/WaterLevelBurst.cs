...
public static class WaterLevelBurst
{
	...
	internal static class GetBuoyancyWaterInfoBatched_000085E9_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<GetBuoyancyWaterInfoBatched_000085E9_0024PostfixBurstDelegate>((GetBuoyancyWaterInfoBatched_000085E9_0024PostfixBurstDelegate)GetBuoyancyWaterInfoBatched).Value;
			}
			P_0 = Pointer;
		}
	...
	internal static class ConstructDeepWaterCommands_000085EA_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<ConstructDeepWaterCommands_000085EA_0024PostfixBurstDelegate>((ConstructDeepWaterCommands_000085EA_0024PostfixBurstDelegate)ConstructDeepWaterCommands).Value;
			}
			P_0 = Pointer;
		}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(WaterLevelJobs_002EGetBuoyancyWaterInfoBatched_000085E9_0024PostfixBurstDelegate))]
	public static void GetBuoyancyWaterInfoBatched(in NativeArray<Vector3> allPositions, in NativeArray<Vector2> allUVPositions, in NativeArray<float> pointTerrainHeightNativeArray, in NativeArray<float> pointWaterHeightNativeArray, in NativeArray<bool> doDeepWaterChecksStateNativeArray, ref NativeArray<WaterLevel.WaterInfo> pointWaterInfoNativeArray, in NativeArray<int> instancePointCountNativeArray, in int instanceCount, in TerrainTopologyMap.TopologyQueryStructure topologyMap, in NativeArray<bool> waterIgnoreStates, ref NativeArray<bool> needsDeepWaterChecks, bool isDeepSea, out bool hasAnyDeepWaterChecks)
	{
		GetBuoyancyWaterInfoBatched_000085E9_0024BurstDirectCall.Invoke(in allPositions, in allUVPositions, in pointTerrainHeightNativeArray, in pointWaterHeightNativeArray, in doDeepWaterChecksStateNativeArray, ref pointWaterInfoNativeArray, in instancePointCountNativeArray, in instanceCount, in topologyMap, in waterIgnoreStates, ref needsDeepWaterChecks, isDeepSea, out hasAnyDeepWaterChecks);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(WaterLevelJobs_002EConstructDeepWaterCommands_000085EA_0024PostfixBurstDelegate))]
	public static void ConstructDeepWaterCommands(in NativeArray<Vector3> allPositions, in NativeArray<WaterLevel.WaterInfo> pointWaterInfoNativeArray, in NativeArray<bool> needsDeepWaterChecks, out NativeList<RaycastCommand> deepWaterCasts, out NativeList<int> raycastPointIndices, Allocator allocator)
	{
		...
		ConstructDeepWaterCommands_000085EA_0024BurstDirectCall.Invoke(in allPositions, in pointWaterInfoNativeArray, in needsDeepWaterChecks, out deepWaterCasts, out raycastPointIndices, allocator);
	}

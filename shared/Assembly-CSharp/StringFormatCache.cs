...
{
	private struct Key1(string format, string value1) : IEquatable<Key1>
	{
	...
	private struct Key2(string format, string value1, string value2) : IEquatable<Key2>
	{
		public string format = format;
	...
	private struct Key3(string format, string value1, string value2, string value3) : IEquatable<Key3>
	{
		public string format = format;
	...
	private struct Key4(string format, string value1, string value2, string value3, string value4) : IEquatable<Key4>
	{
		public string format = format;
	...
	public static string Get(string format, string value1, string value2, string value3, string value4)
	{
		...
		{
			value5 = string.Format(format, new object[4] { value1, value2, value3, value4 });

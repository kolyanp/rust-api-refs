...
public static class RenderInfo
{
	public struct RendererInstance
	{
		...
		public static RendererInstance From(Renderer renderer)
		{
			...
			RendererInstance result = new RendererInstance
			{
				IsVisible = renderer.isVisible,
				CastShadows = ((int)renderer.shadowCastingMode > 0),
			...
			{
				result.ObjectName = TransformEx.GetRecursiveName(((Component)renderer).transform);
			}

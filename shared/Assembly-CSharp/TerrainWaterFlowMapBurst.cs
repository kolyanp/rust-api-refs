...
public static class TerrainWaterFlowMapBurst
{
	...
	internal delegate void GetFlowDirections_00006EC5_0024PostfixBurstDelegate(in NativeArray<Vector3> positions3D, ref NativeArray<float3> results, in NativeArray<byte> source, in int res);

	internal static class GetFlowDirections_00006EC5_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<GetFlowDirections_00006EC5_0024PostfixBurstDelegate>((GetFlowDirections_00006EC5_0024PostfixBurstDelegate)GetFlowDirections).Value;
			}
			P_0 = Pointer;
		}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(GetFlowDirections_00006EC5_0024PostfixBurstDelegate))]
	...
	{
		GetFlowDirections_00006EC5_0024BurstDirectCall.Invoke(in positions3D, ref results, in source, in res);
	}

...
public static class TerrainWaterFlowMapBurst
{
	...
	internal static class GetFlowDirections_00006EC7_0024BurstDirectCall
	{
		...
		private static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			...
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<GetFlowDirections_00006EC7_0024PostfixBurstDelegate>((GetFlowDirections_00006EC7_0024PostfixBurstDelegate)GetFlowDirections).Value;
			}
			P_0 = Pointer;
		}

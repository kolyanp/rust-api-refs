...
public class ReflectionProbeEx : MonoBehaviour
{
	...
	[Serializable]
	public struct RenderListEntry(Renderer renderer, bool alwaysEnabled)
	{
		public Renderer renderer = renderer;

		public bool alwaysEnabled = alwaysEnabled;
	}
	...
	private bool InitializeCubemapFaceMatrices()
	{
		...
		{
			Debug.LogError((object)("[ReflectionProbeEx] Initialization failed. No cubemap ortho basis defined for " + ((object)SystemInfo.graphicsDeviceType/*cast due to constrained. prefix*/).ToString()));
			return false;
		}
		return true;
	}
	...
	private void SafeCreateCubeRT(ref RenderTexture rt, string name, int size, int depth, bool mips, TextureDimension dim, FilterMode filter, RenderTextureFormat format, RenderTextureReadWrite readWrite = (RenderTextureReadWrite)1)
	{

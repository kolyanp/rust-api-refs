...
public class BaseSubmarine : BaseVehicle, IPoolVehicle, IEngineControllerUser, IEntity, IAirSupply
{
	...
	public override void ServerInit()
	{
		...
		InvokeRandomized(SubmarineDecay, Random.Range(30f, 60f), 60f, 6f);
	}
	...
	public override void VehicleFixedUpdate()
	{
		...
		using (TimeWarning.New("BaseSubmarine.VehicleFixedUpdate"))
		{
			...
			if (IsInWater)
			{
				...
				float num6 = rigidBody.linearVelocity.y - targetClimbSpeed;
			...
			if (IsOn() && IsInWater)
			{
				...
				float num10 = turnPower * rigidBody.mass * rigidBody.angularDamping;
			...
			if ((Object)(object)torpedoContainer != (Object)null)
			{
				...
				flagsUpdateScope.Set(Flags.Reserved6, b);
			}

...
public class PrefabReference
{
	...
	public Mesh GetMesh(bool refresh = false)
	{
		...
		List<SkinnedMeshRenderer> list = FTransformMethods.FindComponentsInAllChildren<SkinnedMeshRenderer>(Prefab.transform, false, false);
		...
		List<MeshFilter> list2 = FTransformMethods.FindComponentsInAllChildren<MeshFilter>(Prefab.transform, false, false);
	...
	public Collider GetCollider()
	{
		...
		List<Collider> list = FTransformMethods.FindComponentsInAllChildren<Collider>(Prefab.transform, false, false);
		for (int i = 0; i < list.Count; i++)
		{

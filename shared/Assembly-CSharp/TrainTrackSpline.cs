...
public class TrainTrackSpline : WorldSpline
{
	...
	public struct TrackRequest(TrackSelection trackSelection, TrainTrackSpline preferredAltA, TrainTrackSpline preferredAltB)
	{
		public TrackSelection trackSelection = trackSelection;

		public TrainTrackSpline preferredAltA = preferredAltA;

		public TrainTrackSpline preferredAltB = preferredAltB;
	}

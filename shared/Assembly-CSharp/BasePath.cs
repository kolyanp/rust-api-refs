...
public class BasePath : MonoBehaviour, IAIPath
{
	...
	public ReadOnlySpan<IAIPathInterestNode> InterestNodes => UnsafeListAccess.ListAsReadOnlySpanOf<PathInterestNode, IAIPathInterestNode>(interestZones);

	public ReadOnlySpan<IAIPathSpeedZone> SpeedZones => UnsafeListAccess.ListAsReadOnlySpanOf<PathSpeedZone, IAIPathSpeedZone>(speedZones);

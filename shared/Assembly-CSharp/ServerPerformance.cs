...
public class ServerPerformance : BaseMonoBehaviour
{
	...
	private void WriteLine()
	{
		...
		int num = Object.FindObjectsByType<GameObject>((FindObjectsSortMode)0).Length;
		int num2 = 0;
		int num3 = 0;
		int num4 = 0;
		int num5 = 0;
		...
		File.AppendAllText(fileName, monoUsedSize + "," + usedHeapSize + "," + num7 + "," + count + "," + count2 + "," + NetworkSleep.totalCollidersDisabled + "," + NetworkSleep.totalBehavioursDisabled + "," + num + "," + Object.FindObjectsByType<Collider>((FindObjectsSortMode)0).Length + "," + Object.FindObjectsByType<Rigidbody>((FindObjectsSortMode)0).Length + "," + Object.FindObjectsByType<BuildingBlock>((FindObjectsSortMode)0).Length + "," + num2 + "," + num3 + "," + num4 + "," + num5 + "," + num6 + "," + deaths + "," + spawns + "," + position_changes + "\r\n");
		lastFrame = Time.frameCount;
		deaths = 0uL;
		spawns = 0uL;
	...
	public static void DoReport()
	{
		...
		Object[] objects = (Object[])(object)Object.FindObjectsByType<Transform>((FindObjectsSortMode)0);
		ComponentReport(filename, "All Objects", objects);
		string filename2 = text;
		objects = (Object[])(object)Object.FindObjectsByType<BaseEntity>((FindObjectsSortMode)0);
		ComponentReport(filename2, "Entities", objects);
		string filename3 = text;
		objects = (Object[])(object)Object.FindObjectsByType<Rigidbody>((FindObjectsSortMode)0);
		ComponentReport(filename3, "Rigidbodies", objects);
		string filename4 = text;
		objects = (Object[])(object)(from x in Object.FindObjectsByType<Collider>((FindObjectsSortMode)0)
			where !x.enabled
			select x).ToArray();

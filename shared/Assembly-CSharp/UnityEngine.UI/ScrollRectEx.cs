...
public class ScrollRectEx : UIBehaviour, IInitializePotentialDragHandler, IEventSystemHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutGroup, ILayoutController
{
	...
	private void UpdateCachedData()
	{
		...
		object horizontalScrollbarRect;
		if (!((Object)(object)m_HorizontalScrollbar == (Object)null))
		{
			Transform transform2 = ((Component)m_HorizontalScrollbar).transform;
			horizontalScrollbarRect = ((transform2 is RectTransform) ? transform2 : null);
		}
		else
		{
			horizontalScrollbarRect = null;
		}
		m_HorizontalScrollbarRect = (RectTransform)horizontalScrollbarRect;
		object verticalScrollbarRect;
		if (!((Object)(object)m_VerticalScrollbar == (Object)null))
		{
			Transform transform3 = ((Component)m_VerticalScrollbar).transform;
			verticalScrollbarRect = ((transform3 is RectTransform) ? transform3 : null);
		}
		else
		{
	...
	{
		if (Object.op_Implicit((Object)(object)m_VerticalScrollbar) && m_VerticalScrollbarVisibility != ScrollbarVisibility.Permanent && ((Component)m_VerticalScrollbar).gameObject.activeSelf != vScrollingNeeded)
		{
			((Component)m_VerticalScrollbar).gameObject.SetActive(vScrollingNeeded);
		}
		if (Object.op_Implicit((Object)(object)m_HorizontalScrollbar) && m_HorizontalScrollbarVisibility != ScrollbarVisibility.Permanent && ((Component)m_HorizontalScrollbar).gameObject.activeSelf != hScrollingNeeded)
		{

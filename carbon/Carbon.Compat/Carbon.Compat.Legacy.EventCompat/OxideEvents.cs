...
{
	[Obsolete("Used for oxide backwards compatibility")]
	[UsedImplicitly]
	public class Event
	{
		...
		public void Invoke()
		{
			lock (Lock)
			{
				...
				{
					Callback callback2 = removedQueue.Dequeue();
					callback2.Previous = null;
					callback2.Next = null;
				}
			}
		}
	...
	public class Event<T>
	{
		...
		public void Invoke(T arg0)
		{
			lock (Lock)
			{
				...
				while (removedQueue.Count > 0)
				{
					Event.Callback<T> callback2 = removedQueue.Dequeue();
					callback2.Previous = null;
					callback2.Next = null;
				}
			}
	...
	public class Event<T1, T2>
	{
		...
		public void Invoke()
		{
			lock (Lock)
			{
				...
				while (removedQueue.Count > 0)
				{
					Event.Callback<T1, T2> callback2 = removedQueue.Dequeue();
					callback2.Previous = null;
					callback2.Next = null;
				}
			}
	...
	public class Event<T1, T2, T3>
	{
		...
		public void Invoke()
		{
			lock (Lock)
			{
				...
				while (removedQueue.Count > 0)
				{
					Event.Callback<T1, T2, T3> callback2 = removedQueue.Dequeue();
					callback2.Previous = null;
					callback2.Next = null;
				}
			}
	...
	public class Event<T1, T2, T3, T4>
	{
		...
		public void Invoke()
		{
			lock (Lock)
			{
				...
				while (removedQueue.Count > 0)
				{
					Event.Callback<T1, T2, T3, T4> callback2 = removedQueue.Dequeue();
					callback2.Previous = null;
					callback2.Next = null;
				}
			}
	...
	public class Event<T1, T2, T3, T4, T5>
	{
		...
		public void Invoke()
		{
			lock (Lock)
			{
				...
				while (removedQueue.Count > 0)
				{
					Event.Callback<T1, T2, T3, T4, T5> callback2 = removedQueue.Dequeue();
					callback2.Previous = null;
					callback2.Next = null;
				}
			}

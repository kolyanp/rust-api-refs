...
public class Category_Static
{
	...
	public class Static_Console
	{
		[Patch("IConsoleEnter", "IConsoleEnter", typeof(ConsoleInput), "OnEnter", new Type[] { })]
		[Options(/*Could not decode attribute arguments.*/)]
		public class IConsoleEnter : Patch
		{
			internal static LinkedList<string> history = new LinkedList<string>();
		...
		[Patch("IConsoleUpdate", "IConsoleUpdate", typeof(ConsoleInput), "Update", new Type[] { })]
		[Options(/*Could not decode attribute arguments.*/)]
		public class IConsoleUpdate : Patch
		{
			public static void UpHook(ConsoleInput _this)
			{
				string up = IConsoleEnter.GetUp();
				if (!string.IsNullOrEmpty(up))
				{
					_this.inputString = up;
					_this.RedrawInputLine(true);
				}
			}

			public static void DownHook(ConsoleInput _this)
			{
				string down = IConsoleEnter.GetDown();
			...
			private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions, ILGenerator generator)
			{
				...
				foreach (CodeInstruction instruction in instructions)
				{
					if (flag && !flag2)
					{
						...
						list.Add(new CodeInstruction(OpCodes.Call, (object)typeof(IConsoleUpdate).GetMethod("UpHook", BindingFlags.Static | BindingFlags.Public)));
						...
						list.Add(new CodeInstruction(OpCodes.Ldarg_0, (object)null));
						list.Add(new CodeInstruction(OpCodes.Call, (object)typeof(IConsoleUpdate).GetMethod("DownHook", BindingFlags.Static | BindingFlags.Public)));
						list.Add(new CodeInstruction(OpCodes.Ret, (object)null));
						list.Add(new CodeInstruction(OpCodes.Nop, (object)null)
						{

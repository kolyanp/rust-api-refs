...
public sealed class Switches
{
	...
	public static string GetOnBootCommands(string defaultValue = null)
	{
		return "+carbon.onboot".GetArgumentResult(defaultValue);
	}
	...
	public static string GetOnServerInitCommands(string defaultValue = null)
	{
		return "+carbon.onserverinit".GetArgumentResult(defaultValue);
	}
	...
	public static string GetRootDir(string defaultValue = null)
	{
		return "-carbon.rootdir".GetArgumentResult(defaultValue);
	}
	...
	public static string GetCarbonConfigDir(string defaultValue = null)
	{
		return "-carbon.carbonconfigdir".GetArgumentResult(defaultValue);
	}

	[Switch(Name = "-carbon.scriptdir", Help = "Overrides the scripts directory of Carbon, aka the \"carbon/plugins\" folder.")]
	public static string GetScriptDir(string defaultValue = null)
	{
		return "-carbon.scriptdir".GetArgumentResult(defaultValue);
	}

	[Switch(Name = "-carbon.configdir", Help = "Overrides the config directory of Carbon, aka the \"carbon/configs\" folder.")]
	public static string GetConfigDir(string defaultValue = null)
	{
		return "-carbon.configdir".GetArgumentResult(defaultValue);
	}

	[Switch(Name = "-carbon.datadir", Help = "Overrides the data directory of Carbon, aka the \"carbon/data\" folder.")]
	public static string GetDataDir(string defaultValue = null)
	{
		return "-carbon.datadir".GetArgumentResult(defaultValue);
	}

	[Switch(Name = "-carbon.modifierdir", Help = "Overrides the modifier directory of Carbon, aka the \"carbon/modifiers\" folder.")]
	public static string GetModifierDir(string defaultValue = null)
	{
		return "-carbon.modifierdir".GetArgumentResult(defaultValue);
	}

	[Switch(Name = "-carbon.langdir", Help = "Overrides the lang directory of Carbon, aka the \"carbon/lang\" folder.")]
	public static string GetLangDir(string defaultValue = null)
	{
		return "-carbon.langdir".GetArgumentResult(defaultValue);
	}

	[Switch(Name = "-carbon.extdir", Help = "Overrides the extensions directory of Carbon, aka the \"carbon/extensions\" folder.")]
	public static string GetExtDir(string defaultValue = null)
	{
		return "-carbon.extdir".GetArgumentResult(defaultValue);
	}

	[Switch(Name = "-carbon.moduledir", Help = "Overrides the modules directory of Carbon, aka the \"carbon/modules\" folder.")]
	public static string GetModuleDir(string defaultValue = null)
	{
		return "-carbon.moduledir".GetArgumentResult(defaultValue);
	}

	[Switch(Name = "-carbon.logdir", Help = "Overrides the log directory of Carbon, aka the \"carbon/logs\" folder.")]
	public static string GetLogDir(string defaultValue = null)
	{
		return "-carbon.logdir".GetArgumentResult(defaultValue);
	}
	...
	public static string GetProfileDir(string defaultValue = null)
	{
		return "-carbon.profiledir".GetArgumentResult(defaultValue);
	}
	...
	public static string GetSQLPermissionsDatabase(string defaultValue = null)
	{
		return "-carbon.sqlpermsdb".GetArgumentResult(defaultValue);
	}

	[Switch(Name = "-harmonydir", Help = "Overrides the directory of Rust's HarmonyMods folder.")]
	public static string GetHarmonyDir(string defaultValue = null)
	{
		return "-harmonydir".GetArgumentResult(defaultValue);
	}
}

...
public class Formatter
{
	...
	public static string ToUnity(string text)
	{
		...
		dictionary[ElementType.Color] = (object c) => new Tag($"<color=#{c}>", "</color>");
		dictionary[ElementType.Size] = (object s) => new Tag($"<size={s}>", "</size>");
	...
	static Formatter()
	{
		...
		closeTags = new Dictionary<ElementType, TokenType?>
		{
